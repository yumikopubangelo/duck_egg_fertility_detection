...
class UNetTrainer:
    ...
    def train(
        self, num_epochs: int, save_dir: str, patience: int = 10, verbose: bool = True
    ) -> Dict:
        """
...
def create_trainer(model_config: Dict, data_config: Dict, training_config: Dict) -> UNetTrainer:
    """
    ...
    transform = transforms.Compose(
        [transforms.Resize(data_config.get("image_size", (256, 256))), transforms.ToTensor()]
    )
